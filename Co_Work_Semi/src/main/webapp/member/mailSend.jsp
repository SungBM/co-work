...
<%	//값을 여기에다가 집어넣어서 보내기. 자바에서 jsp아님
	request.setCharacterEncoding("utf-8");  
	String sender=request.getParameter("sender");  //내 메일
	String receiver=request.getParameter("receiver"); //회원가입 이메일. @까지 다 붙여서
	String subject=request.getParameter("subject"); //이메일 인증
	String content=request.getParameter("content"); // 이메일 인증번호는 + 난수발생한 값
	/*
