										...
										<div class="col-lg-7">
											<div class="text-center">
												<h4 class="mb-3">
													...
													<span class="text-primary">5k</span>
													+ Satisfied clients
												</h4>
												<div dir="ltr">
								...
								<div class="my-auto">
									...
									<div class="mt-4">
										<form name="loginform" action="main.net" method="post">
											...
											<div class="mb-3">
												...
												<div class="input-group auth-pass-inputgroup">
													<input type="password" class="form-control" id="pass" aria-label="Password" placeholder="Enter password" name="pass" required aria-describedby="password-addon">
												</div>
											</div>
											<div class="form-check">
												<input class="form-check-input" type="checkbox" id="remember-check" name="remember-check" value="store">
												<label class="form-check-label" for="remember-check"> 아이디 기억하기 </label>
											</div>
										...
										<div class="mt-5 text-center">
											<p>Don't have an account ? <a href="join.net" class="fw-medium text-primary"> 회원가입 </a>
											</p>
										</div>
									</div>
								</div>
