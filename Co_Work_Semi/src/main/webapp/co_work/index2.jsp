			...
			<div class="navbar-header">
				<div class="d-flex">
					...
					<div class="navbar-brand-box">
						<a class="logo logo-dark"> <span class="logo-sm"> <img
								src="assets/images/logo.svg" alt="" height="22">
						</span> <span class="logo-lg"> <img
								src="assets/images/logo-dark.png" alt="" height="17">
						</span>
						</a> <a class="logo logo-light"> <span class="logo-sm"> <img
								src="assets/images/logo-light.svg" alt="" height="22">
						</span> <span class="logo-lg"> <img
						...
						<div class="dropdown-menu dropdown-megamenu">
							<div class="row">
								<div class="col-sm-8">
									...
									<div class="row">
										<div class="col-md-4">
											<h5 class="font-size-14 mt-0" key="t-ui-components">UI
												Components</h5>
										...
										<div class="col-md-4">
											<h5 class="font-size-14 mt-0" key="t-extra-pages">Extra
												Pages</h5>
											<ul class="list-unstyled megamenu-list">
				...
				<div class="d-flex">
					...
					<div class="dropdown d-inline-block">
						<button type="button" class="btn header-item waves-effect"
							...
							aria-expanded="false">
							<img id="header-lang-img" src="assets/images/flags/us.jpg"
						...
						<div class="dropdown-menu dropdown-menu-end">
							...
							<a href="javascript:void(0);"
								...
								src="assets/images/flags/us.jpg" alt="user-image" class="me-1"
							...
							<a href="javascript:void(0);"
								...
								src="assets/images/flags/russia.jpg" alt="user-image"
						...
						<div class="dropdown-menu dropdown-menu-lg dropdown-menu-end">
							<div class="px-lg-2">
								...
								<div class="row g-0">
									<div class="col">
										<a class="dropdown-icon-item" href="#"> <img
											src="assets/images/brands/dropbox.png" alt="dropbox"> <span>Dropbox</span>
										</a>
									</div>
									<div class="col">
										<a class="dropdown-icon-item" href="#"> <img
								...
								<a href="" class="text-reset notification-item">
									<div class="d-flex">
										...
										<div class="flex-grow-1">
											<h6 class="mt-0 mb-1" key="t-your-order">Your order is
												placed</h6>
									...
									<div class="d-flex">
										...
										<div class="flex-grow-1">
											<h6 class="mt-0 mb-1" key="t-shipped">Your item is
												shipped</h6>
											<div class="font-size-12 text-muted">
												<p class="mb-1" key="t-grammer">If several languages
													coalesce the grammar</p>
			...
			<div class="p-4">
				...
				<div class="form-check form-switch mb-3">
					<input class="form-check-input theme-choice" type="checkbox"
						id="light-mode-switch" checked> <label
						class="form-check-label" for="light-mode-switch">Light
						Mode</label>
				</div>
				...
				<div class="form-check form-switch mb-3">
					<input class="form-check-input theme-choice" type="checkbox"
						...
						data-appStyle="assets/css/app-dark.min.css"> <label
						class="form-check-label" for="dark-mode-switch">Dark Mode</label>
				</div>
				...
				<div class="form-check form-switch mb-5">
					<input class="form-check-input theme-choice" type="checkbox"
						id="dark-rtl-mode-switch"> <label class="form-check-label"
