            ...
            <div class="navbar-header">
                <div class="d-flex">
                    ...
                    <div class="navbar-brand-box">
                        <a href="login.net" class="logo logo-dark">   <!-- 여기 주소 바꾸기 시작시 로그인 페이지-->
                            <span class="logo-sm">
                        ...
                        <a href="ProjectList.po" class="logo logo-light">
                            <span class="logo-sm">
                    ...
                    <ul class="metismenu list-unstyled" id="side-menu">
                            ...
                            <ul class="sub-menu" aria-expanded="true">
                                <li>
                                    ...
                                    <ul class="sub-menu" aria-expanded="true">
                                        ...
                                        <li><a target="_blank" href="layouts-compact-sidebar.html" key="t-compact-sidebar">Compact Sidebar</a></li>
                                        ...
                                        <li><a target="_blank" href="layouts-colored-sidebar.html" key="t-colored-sidebar">Colored Sidebar</a></li>
                                ...
                                <li>
                                    ...
                                    <ul class="sub-menu" aria-expanded="true">
                                        ...
                                        <li><a target="_blank" href="layouts-hori-colored-header.html" key="t-colored-topbar">Colored Header</a></li>
                        ...
                        <li>
                            ...
                            <ul class="sub-menu" aria-expanded="false">
                                ...
                                <li><a href="crypto-ico-landing.html" key="t-ico" target="_blank">ICO Landing</a></li>
                            </ul>
                        </li>
                        ...
                        <li>
                            ...
                            <ul class="sub-menu" aria-expanded="false">
                                ...
                                <li><a target="_blank" href="auth-recoverpw-2.html" key="t-recover-password-2">Recover Password 2</a></li>
                                ...
                                <li><a target="_blank" href="auth-confirm-mail.html" key="t-confirm-mail">Confirm Email</a></li>
                                <li><a target="_blank" href="auth-confirm-mail-2.html" key="t-confirm-mail-2">Confirm Email 2</a></li>
                                <li><a target="_blank" href="auth-email-verification.html" key="t-email-verification">Email verification</a></li>
                                <li><a target="_blank" href="auth-email-verification-2.html" key="t-email-verification-2">Email Verification 2</a></li>
                                <li><a target="_blank" href="auth-two-step-verification.html" key="t-two-step-verification">Two Step Verification</a></li>
                                <li><a target="_blank" href="auth-two-step-verification-2.html" key="t-two-step-verification-2">Two Step Verification 2</a></li>
                            </ul>
                        </li>
