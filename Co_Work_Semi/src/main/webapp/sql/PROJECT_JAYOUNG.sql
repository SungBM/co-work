...
PROJECT_STATE	 		VARCHAR2(20), --상태, 진행중(1)
PROJECT_PROG	 		NUMBER,  --진행률 
PROJECT_START 			DATE,
PROJECT_END	 			DATE,
PROJECT_PRIORITY 		VARCHAR2(20), -- 우선순위
PROJECT_ADMIN	 		VARCHAR2(30) NOT NULL, -- 관리자
...
--FOREIGN KEY(PROJECT_ADMIN) REFERENCES USER_INFO(USER_NAME) ON DELETE CASCADE
);
...
INSERT INTO PROJECT
(PROJECT_NUM, PROJECT_NAME, PROJECT_STATE, PROJECT_START, PROJECT_END, PROJECT_ADMIN)
VALUES(PROJECT_SEQ.NEXTVAL,'프로젝트1', '진행중', '2023-02-13', '2023-02-13', 'HTA1')

INSERT INTO PROJECT
(PROJECT_NUM, PROJECT_NAME, PROJECT_STATE, PROJECT_START, PROJECT_END, PROJECT_ADMIN)
VALUES(PROJECT_SEQ.NEXTVAL,'프로젝트2', '진행중', '2023-02-13', '2023-02-29', 'HTA1');

INSERT INTO PROJECT
(PROJECT_NUM, PROJECT_NAME, PROJECT_STATE, PROJECT_START, PROJECT_END, PROJECT_ADMIN)
VALUES(PROJECT_SEQ.NEXTVAL,'프로젝트3', '진행중', '2023-02-15', '2023-03-01', 'HTA1')

INSERT INTO PROJECT
(PROJECT_NUM, PROJECT_NAME, PROJECT_STATE, PROJECT_START, PROJECT_END, PROJECT_ADMIN)
VALUES(PROJECT_SEQ.NEXTVAL,'프로젝트4', '진행중', '2023-02-13', '2023-02-13', 'HTA1')

INSERT INTO PROJECT
(PROJECT_NUM, PROJECT_NAME, PROJECT_STATE, PROJECT_START, PROJECT_END, PROJECT_ADMIN)
VALUES(PROJECT_SEQ.NEXTVAL,'프로젝트5', '진행중', '2023-02-13', '2023-02-13', 'HTA1')
